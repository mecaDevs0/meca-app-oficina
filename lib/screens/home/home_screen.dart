...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  bool get _isDataBankInvalid {
    return _workshopData?['bank_account'] == null;
  }

  bool get _isAgendaInvalid {
    return _workshopData?['schedule'] == null || 
           (_workshopData?['schedule'] as List).isEmpty;
  }

  bool get _isServiceInvalid {
    return _workshopData?['services'] == null || 
           (_workshopData?['services'] as List).isEmpty;
  }
