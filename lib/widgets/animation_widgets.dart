...
class AnimationWidgets {
  ...
  static Widget buildEnterAnimation({double? width, double? height}) {
    return Container(
      width: width ?? 500, // Aumentado de 400 para 500
      height: height ?? 500, // Aumentado de 400 para 500
      child: Image.asset(
  ...
  static Widget buildLoadingAnimation({double? width, double? height}) {
    return Container(
      width: width ?? 250, // Aumentado de 200 para 250
      height: height ?? 250, // Aumentado de 200 para 250
      child: Image.asset(
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            buildEnterAnimation(width: 450, height: 450), // Aumentado de 350 para 450
      ...
      child: Column(
        ...
        children: [
          buildLoadingAnimation(
            width: size ?? 220, // Aumentado de 180 para 220
            height: size ?? 220, // Aumentado de 180 para 220
          ),
          if (message != null) ...[
